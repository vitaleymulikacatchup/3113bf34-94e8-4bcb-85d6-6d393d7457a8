...
export const metadata: Metadata = {
  ...
  description: "Discover the finest specialty coffee blends from around the world. Ethically sourced, expertly roasted, and crafted with passion at Brew Haven.",
  keywords: "specialty coffee, single origin, coffee beans, organic coffee, ethical sourcing",
  openGraph: {
    title: "Brew Haven - Premium Specialty Coffee",
    description: "Discover the finest specialty coffee blends from around the world. Ethically sourced, expertly roasted, and crafted with passion.",
    siteName: "Brew Haven",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34Qgyh3s7JYDSgc82AIVt5yiftd/uploaded-1764168862667-uwdylu8a.jpg",
  ...
  twitter: {
    ...
    title: "Brew Haven - Premium Specialty Coffee",
    description: "Ethically sourced, expertly roasted coffee crafted with passion",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34Qgyh3s7JYDSgc82AIVt5yiftd/uploaded-1764168862667-uwdylu8a.jpg"]
  }
};
